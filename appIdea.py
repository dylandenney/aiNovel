...
def generate_story(keywords, model, tokenizer, max_length=2000):
    prompt = f"Create a interactive fun math game for children with 17q12 deletion syndrome using python flask, html, java script, css: {', '.join(keywords)}"
